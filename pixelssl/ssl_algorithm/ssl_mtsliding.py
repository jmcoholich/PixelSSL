...
def ssl_mtsliding(args, model_dict, optimizer_dict, lrer_dict, criterion_dict, task_func):
...
class SSLMTSLIDING(ssl_base._SSLBase):
    ...
    def _train(self, data_loader, epoch):
        ...
        for idx, (inp, gt) in enumerate(data_loader):
            ...
            with torch.no_grad():
                t_resulter, t_debugger = self.t_model.forward(t_inp, slide = True)
